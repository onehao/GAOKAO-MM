...
if __name__ == "__main__":
    ...
    openai_key = ""
    openai_base_url = "https://cloud.infini-ai.com/maas/deepseek-v3/nvidia"

    model_api = OpenaiAPI(openai_key, openai_base_url, model_name="deepseek-v3", temperature=0.6, max_tokens=4096)
    data_example = {
            "year": "2017",
            "category": "新课标Ⅰ",
