...
from Models.infini_ai_deepseek import OpenaiAPI
...
if __name__ == "__main__":
    ...
    model_name = "deepseek-r1" #"gpt-4-vision-preview"
    # openai_key = args.openai_api_key
    # openai_base_url = "https://api.openai.com/v1"
    openai_key = ""
    openai_base_url = "https://cloud.infini-ai.com/maas/deepseek-r1/nvidia"
    model_api = OpenaiAPI(openai_key, openai_base_url, model_name="deepseek-r1", temperature=0.6, max_tokens=4096)
